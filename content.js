const content = {
    ...
    about: {
        title: "About",
        subtitle: "",
        body: "<img class='smaller-img' src='images/me.png'/><br><br>Isabel Lee is a creative technologist, writer, and artist based in New York City.<br><br>Born in Chicago, Isabel received her BS in Computer Science at Yale University and her MPS in <a src='https://itp.nyu.edu/itp/' target='_blank'>Interactive Telecommunications</a> from NYU</a>. She currently works as a game engineer at <a href='https://www.seconddinner.com/'>Second Dinner</a>, and her previous work experience incluldes software engineering at Google and NASA Jet Propulsion Laboratory. <br><br>Isabel loves puzzles, both making and solving. Her work highlights curious game design and creative interaction. This is a selected portolfio of recent projects; a larger collection is available upon request.<br><br> <div id='icons'><a href='https://www.linkedin.com/in/isabel-lee-360875121/' target='_blank'><img class='icon' src='/images/linkedin.png'/></a>&emsp;&emsp;<a href='mailto:isabelringing1@gmail.com' target='_blank'><img class='icon' src='/images/email.png'/></a></div><br><a href='https://docs.google.com/viewer?url=https://docs.google.com/document/d/1LMMG6wkSL7sFzevMYxE7FPuaBgYVlvn7pRfpuAolwaM/export?format=pdf'target='_blank'>Resume</a> ",
    },
    landing: {
        title: "",
        subtitle: "",
